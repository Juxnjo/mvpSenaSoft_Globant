...
class Tickets(models.Model):
    ...
    frecuency_attendance = models.CharField(max_length=50)
    ...
    hours_worked = models.CharField(max_length=100)
    family_support = models.CharField(max_length=50)
    stress_levels = models.PositiveIntegerField()
    stress_source = models.CharField(max_length=100)
