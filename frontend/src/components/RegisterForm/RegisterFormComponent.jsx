    ...
    return (
        <>
            <form action="">
                ...
                <button type='submit' className='bg-semiDarkBlue w-3/4 hover:bg-semiLightBlue text-white font-semibold my-2 py-2 px-4 rounded-md'>Login</button>
            </form>
            <div>
                <p>Don't you have an account? <Link to='/login' className="text-lightBlue">Sign up.</Link></p>
            </div>
        </>
    )
}
