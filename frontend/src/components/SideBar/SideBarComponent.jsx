...
export const SideBarComponent = () => {
  ...
  return (
    <> <div className="absolute right-10 top-10 font-bold text-4xl z-20 text-white sm:block lg:hidden" onClick={toggleSidebar}>x</div>
      <div
      ...
      >
        ...
        <div className='w-full p-16 text-center flex justify-center text-white cursor-pointer'>
